...
def _build_coordinator_stub(
    *,
    ...
    # Phase 14.A: `_setup_resume_continuation` calls
    # `clip_manager.auto_close_open_clips_for_session` if present.
    # None disables that path — these tests don't seed any clips.
